    ...
    ui(new Ui::MainWindow)
{
    ...
    ui->tableView->horizontalHeader()->setStyleSheet(
                            ...
                            "stop:0 rgb(46,46,46),stop:1 rgb(66,66,66));"
                            "color: rgb(210,210,210);;padding-left: 4px;"
                            "border: 1px solid #383838;}"); //设置表头背景色
    ...
    ui->tableView_3->horizontalHeader()->setStyleSheet(
                "QHeaderView::section{background-color:"
                " qlineargradient(x1:0, y1:0, x2:0, y2:1,"
                " stop:0 rgb(46,46,46),stop:1 rgb(66,66,66));"
                "color: rgb(210,210,210);;padding-left: 4px;"
